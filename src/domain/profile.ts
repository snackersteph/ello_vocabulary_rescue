...
export const BRIAN_PROFILE: ReadingProfile = {
  ...
  // 4+ consecutive dots = sustained stall, matching the CLAUDE.md typing convention.
  // 1-2 dots = brief hesitation, 3-4 = noticeable pause — neither triggers intervention.
  pauseThreshold: 4,
